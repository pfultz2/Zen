...
ZEN_DETAIL_FUNCTION_CLASS_CONDITIONAL(ZEN_DETAIL_FUNCTION_CLASS_OVERLOAD_NAME(i, name), BOOST_PP_SEQ_ELEM(0, seq), ZEN_PP_SEQ_SPLIT(BOOST_PP_SEQ_TAIL(seq), ZEN_DETAIL_FUNCTION_CLASS_CONDITIONAL_P, data))
