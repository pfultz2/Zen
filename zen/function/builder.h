...
#define ZEN_DETAIL_FUNCTION_CLASS_XX(...) __VA_ARGS__
#define ZEN_DETAIL_FUNCTION_CLASS_X(...) ZEN_DETAIL_FUNCTION_CLASS_XX(ZEN_DETAIL_FUNCTION_CLASS_XX(__VA_ARGS__))
