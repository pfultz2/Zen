...
#ifndef ZEN_GUARD_ITERATOR_FUSION_ITERATOR_H
#define ZEN_GUARD_ITERATOR_FUSION_ITERATOR_H
...
#ifndef ZEN_FUSION_ITERATOR_MAX
#define ZEN_FUSION_ITERATOR_MAX 20
#endif
...
#define ZEN_ITERATOR_FUSION_RETURN_AT(z, n, _) case n: return boost::fusion::at_c<n>(seq);

#define ZEN_ITERATOR_FUSION_DEREF(z, n, data) \
...
{ \
    ...
    { \
        switch (index) \
        { \
            BOOST_PP_REPEAT_ ## z(n, ZEN_ITERATOR_FUSION_RETURN_AT, ~) \
        default: \
            throw std::out_of_range("Fusion iterator out of range access"); \
        } \
    } \
};
BOOST_PP_REPEAT_1(ZEN_FUSION_ITERATOR_MAX, ZEN_ITERATOR_FUSION_DEREF, ~)
#undef ZEN_ITERATOR_FUSION_RETURN_AT
#undef ZEN_ITERATOR_FUSION_DEREF
