...
#ifndef ZEN_GUARD_ITERATOR_MBIND_ITERATOR_H
#define ZEN_GUARD_ITERATOR_MBIND_ITERATOR_H
...
template<class OuterIterator, class Selector, class SelectorRange = typename zen::result_of<Selector(typename boost::iterator_reference<OuterIterator>::type)>::type>
